...
while i in range(5):
    ...
    if (not combat_strength.isnumeric()) or (not m_combat_strength.isnumeric()):
        ...
        print("One or more invalid inputs. Player needs to enter the integer numbers for Combat Strength")
        i = i + 1
        continue
...
belt.sort()
print("Your belt items that are sorted : ", belt)
