...
# Lab 06 - Question 5
last_saved = functions_lab06.load_saved()
print(f"      |    Loaded game: {last_saved}")
...
if not input_invalid:
  ...
  @        ..@#% @     @&*#@(         % 
   &   (  @    (   / /   *    @  .   /  
    ...
    # Lab 06 - Question 5b
    combat_strength, m_combat_strength = functions_lab06.adjust_combat_strengths(last_saved, combat_strength, m_combat_strength)
